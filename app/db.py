...
SCHEMA = '''
CREATE TABLE IF NOT EXISTS runs (id TEXT PRIMARY KEY, stage TEXT NOT NULL, gold INTEGER NOT NULL DEFAULT 0, reroll_tokens INTEGER NOT NULL DEFAULT 1, hp INTEGER NOT NULL DEFAULT 7000, enemy_hp INTEGER NOT NULL DEFAULT 250, q_stage INTEGER NOT NULL DEFAULT 1, e_lifesteal_turns INTEGER NOT NULL DEFAULT 0, ult_turns INTEGER NOT NULL DEFAULT 0, boss_hp INTEGER NOT NULL DEFAULT 32000, boss_awakened INTEGER NOT NULL DEFAULT 0, won INTEGER NOT NULL DEFAULT 0);
